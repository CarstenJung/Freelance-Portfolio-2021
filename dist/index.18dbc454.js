...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Bjehw":[function(require,module,exports) {
...
setTimeout(()=>{
    /*BURGER MENU*/ (0, _gsapDefault.default).to(".burgerMenu", {
        paddingTop: "0px",
    ...
    /* GO BACK BTN */ (0, _gsapDefault.default).to(".goBack", {
        opacity: 1,
        delay: 1,
        duration: 3,
        scrollTrigger: {
...
/* HIDE COOKIE CONSENT */ (0, _gsapDefault.default).to(".cookieConsent", {
    opacity: 0,
    scrollTrigger: {
        trigger: ".section5",
        end: "bottom 800px",
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    /* EVENT LISTENER */ btnForward.addEventListener("click", ()=>{
        changeSlide(true);
    });
...
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
(0, _gsapDefault.default).fromTo(".cookieConsent", {
    opacity: 0
}, {
    opacity: 1,
    duration: 3
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gEwwu","1SICI"], "1SICI", "parcelRequire3355")
